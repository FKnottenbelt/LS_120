...
class SecurityLogger
  def create_log_entry
    # ... implementation omitted ...
    puts "your acces is being logged"
  end
end

secret = SecretFile.new('hush!')
p secret.data

# ls
=begin
First modify the initialize method to take a SecurityLogger object
as an argument and assign it to another instance variable.
...
Second, Alyssa needs to remove the attr_reader and replace it with
an explicit implementation of a method that returns the data instance
