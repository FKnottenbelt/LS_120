...
Valentina is using a new task manager program she wrote. When
interacting with her task manager, an error is raised that
...
# "avoid shadowing methods with local variables unless they are
# both equivalent."