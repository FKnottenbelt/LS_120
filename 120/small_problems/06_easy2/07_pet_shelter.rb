...
that might be needed. In our solution, the Pet class has two String
collaborator objects, Owner has a String and an Array of Pet objects, and
Shelter has a Hash of Owner objects.
...
your class system at all? Were you able to make all of your changes without
